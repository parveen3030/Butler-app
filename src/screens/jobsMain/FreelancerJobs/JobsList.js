...
const JobsList = ({ navigation, route }) => {
  ...
  const { jobs, jobInvites} = useSelector((state) => state.job);
      ...
      <View style={styles.mainView}>
        ...
        <FlatList
          ...
          renderItem={({ index, item }) => {
            const jobItem = jobType == "New Jobs" ? item.job[0] : item
            return (
              <TouchableOpacity
                onPress={() =>
              ...
              >
                <View style={styles.imgView}>
                  <Image
                    style={styles.jobImg}
                    resizeMode="contain"
                    source={getImageByName(jobItem?.category?.name)}
                  />
                </View>
                <View style={styles.cardContent}>
                  ...
                  <View style={styles.cardRow}>
                    ...
                    >
                      ...
                      />
                      <Text style={styles.cardTxt}>{jobItem.price}</Text>
                    </View>
                    <View style={R.appStyles.rowCenter}>
                      ...
                      <Text style={styles.cardTxt}>
                        {moment(jobItem.endDate).format("MMM DD, YYYY")}
                      </Text>
                    </View>
                  </View>
                </View>
